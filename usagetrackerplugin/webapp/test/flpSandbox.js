		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Usage Tracker Plugin",
									"targetURL": "#bsxusagetrackerplugin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bsxusagetrackerplugin-display": {
								"semanticObject": "bsxusagetrackerplugin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bsx.usagetrackerplugin",
									"url": sap.ui.require.toUrl("bsx/usagetrackerplugin")
								}
							}
						}
					}
